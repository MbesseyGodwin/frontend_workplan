                            ...
                            <Table className='border border-dark' bordered hover>
                                ...
                                <tbody>
                                    ...
                                    {unitTasks.map((task, index) => (
                                        <tr key={index}>
                                            {/* Generate table rows including input fields for vehicle_name and pilot_name */}
                                                ...
                                                !excludedKeys.includes(key) && (
                                                    <td key={columnIndex} className='text-xs'>
                                                        {key === 'vehicle_name' || key === 'pilot_name' ? (
                                                            <input
                                                                type="text"
                                                                value={inputValues[task.workplan_id]?.[key] || value} // Use input value if available, else use original value
